 ...
 */
return array(
	'title'      => __( 'Default footer', 'exclusive-theme' ),
	...
	'content'    => '<!-- wp:group {"align":"full","layout":{"inherit":true}} -->
					...
					sprintf(
						...
						esc_html__( 'Proudly powered by %s', 'exclusive-theme' ),
						'<a href="' . esc_url( __( 'https://wordpress.org', 'exclusive-theme' ) ) . '" rel="nofollow">WordPress</a>'
					) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:group --></div>
					<!-- /wp:group -->',
