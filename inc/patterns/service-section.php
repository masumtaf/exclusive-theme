<?php
/**
 * Default Service Section block pattern
 */
return array(
	'title'      => __( 'Services Box', 'exclusive-theme' ),
	'categories' => array( 'exclusive-basic' ),
	'content'    => '
                    <!-- wp:cover {"url":"' . esc_url( EXSIT_URI ) . 'assets/img/achievement-analysis-brainstorming-business-business-plan-caucasian-1448601-pxhere.com.jpg","id":27,"dimRatio":80,"overlayColor":"black","focalPoint":{"x":"0.48","y":0.51},"minHeight":1055,"minHeightUnit":"px","style":{"spacing":{"padding":{"bottom":"100px"}}}} -->
                    ...
                    <h2 class="has-text-align-center has-white-color has-text-color" style="font-size:32px;font-style:normal;font-weight:500">What Service We Offer</h2>
                    <!-- /wp:heading -->
                    ...
                    <div class="wp-block-column" style="padding-right:70px;padding-left:70px"><!-- wp:paragraph {"align":"center","textColor":"white"} -->
                    ...
                    <h2 class="has-text-align-center has-text-color" style="color:#1d222a;font-size:22px;font-style:normal;font-weight:500;margin-top:20px">Investment Planning</h2>
                    <!-- /wp:heading -->
                    ...
                    <!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"},"style":{"spacing":{"margin":{"top":"10px"}}}} -->
                    <div class="wp-block-buttons" style="margin-top:10px"><!-- wp:button {"backgroundColor":"white","textColor":"primary","style":{"spacing":{"padding":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}},"typography":{"fontSize":"14px","fontWeight":"300"}}} -->
                    <div class="wp-block-button has-custom-font-size" style="font-size:14px;font-weight:300;"><a class="wp-block-button__link has-primary-color has-white-background-color has-text-color has-background" style="padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px">Read More  →</a></div>
                    <!-- /wp:button --></div>
                    <!-- /wp:buttons -->
                    ...
                    <!-- wp:column {"style":{"spacing":{"padding":{"top":"50px","right":"40px","bottom":"50px","left":"40px"}}},"backgroundColor":"white","className":"financio-radius-10"} -->
                    <div class="wp-block-column financio-radius-10 has-white-background-color has-background" style="padding-top:50px;padding-right:40px;padding-bottom:50px;padding-left:40px"><!-- wp:image {"align":"center","id":147,"width":80,"height":80,"sizeSlug":"full","linkDestination":"none"} -->
                    ...
                    <!-- wp:heading {"textAlign":"center","style":{"color":{"text":"#1d222a"},"spacing":{"margin":{"top":"20px"}},"typography":{"fontSize":"22px","fontStyle":"normal","fontWeight":"500"}}} -->
                    <h2 class="has-text-align-center has-text-color" style="color:#1d222a;font-size:22px;font-style:normal;font-weight:500;margin-top:20px">Audit &amp; Asurance</h2>
                    <!-- /wp:heading -->
                    ...
                    <!-- wp:column {"style":{"spacing":{"padding":{"top":"50px","right":"40px","bottom":"50px","left":"40px"}}},"backgroundColor":"white","className":"financio-radius-10"} -->
                    <div class="wp-block-column financio-radius-10 has-white-background-color has-background" style="padding-top:50px;padding-right:40px;padding-bottom:50px;padding-left:40px"><!-- wp:image {"align":"center","id":148,"width":80,"height":80,"sizeSlug":"full","linkDestination":"none"} -->
                    ...
                    <!-- wp:heading {"textAlign":"center","style":{"color":{"text":"#1d222a"},"spacing":{"margin":{"top":"20px"}},"typography":{"fontSize":"22px","fontStyle":"normal","fontWeight":"500"}}} -->
                    <h2 class="has-text-align-center has-text-color" style="color:#1d222a;font-size:22px;font-style:normal;font-weight:500;margin-top:20px">Business Taxation</h2>
                    <!-- /wp:heading -->
